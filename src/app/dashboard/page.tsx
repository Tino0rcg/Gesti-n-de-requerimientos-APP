  ...
  return (
    <div className="flex flex-col gap-8">
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
        <div>
          <h1 className="text-2xl sm:text-4xl font-black tracking-tighter text-white uppercase italic">Overview Operativo</h1>
        ...
        <div className="flex items-center gap-3 w-full sm:w-auto">
            ...
            <Button className="w-full sm:w-auto bg-primary hover:bg-primary/90 text-black font-bold shadow-[0_0_20px_rgba(59,130,246,0.3)]">
